...
<head>
  <title>Be Cron - 在线Cron表达式生成器</title>
    ...
    <link href="${ctxStatic}/Cron/themes/bootstrap/easyui.min.css" rel="stylesheet" type="text/css" />
    <link href="${ctxStatic}/Cron/themes/icon.css" rel="stylesheet" type="text/css" />
    <link href="${ctxStatic}/Cron/icon.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        .line
        {
            height: 25px;
    ...
    <script src="${ctxStatic}/Cron/jquery-1.6.2.min.js" type="text/javascript"></script>
    <script src="${ctxStatic}/Cron/jquery.easyui.min.js" type="text/javascript"></script>
    <script src="${ctxStatic}/Cron/cron.js" type="text/javascript"></script>
...
<body>
    <center>
        <div class="easyui-layout" style="width:830px;height:560px; border: 1px rgb(202, 196, 196) solid;
            border-radius: 5px;display: none;"  id="easy-ui-center">
