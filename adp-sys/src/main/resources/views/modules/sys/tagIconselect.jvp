...
<head>
    ...
    <script type="text/javascript">
	    $(document).ready(function(){
	    	$(".fontawesome-icon-list a").click(function(){
	    		...
	    		$(".fa-hover a").removeClass("clicked");
	...
	/*     		$(this).children("i").addClass("icon-white"); */
	    	...
	    	$(".fontawesome-icon-list a").dblclick(function(){
	    		$("#icon").val($(this).text());
...
<div class="icons ibox float-e-margins">
  <div class="ibox-title">
   		 ${fns:i18nMessage('icon.selectIcon')}
...
<!--           <a class="collapse-link">
  ...
  <div class="ibox-content icons-box">
      <section id="new">
          <h2 >${fns:i18nMessage('icon.customIcons')}</h2>
          <div class="row fontawesome-icon-list">
          <div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-buy_management"></i>zhil-buy_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-code_generation"></i>zhil-code_generation</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-institutional_users"></i>zhil-institutional_users</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa  zhil-logistics_company_management"></i> zhil-logistics_company_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-materal_properties"></i>zhil-materal_properties</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-product_outbox"></i>zhil-product_outbox</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-product_packing"></i>zhil-product_packing</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-system_setting"></i>zhil-system_setting</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-vmi_store_management"></i>zhil-vmi_store_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-syetem_management"></i>zhil-syetem_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-task_scheduling_management"></i>zhil-task_scheduling_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-the_goods_management"></i>zhil-the_goods_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-warehouse_iset"></i>zhil-warehouse_iset</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-app_job_information"></i>zhil-app_job_information</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-app_manage"></i>zhil-app_manage</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-appplication_management"></i>zhil-appplication_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-barcode_basic_information"></i>zhil-barcode_basic_information</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-barcode_inventory"></i>zhil-barcode_inventory</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-barcode_inventory_query"></i>zhil-barcode_inventory_query</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-box_code_management"></i>zhil-box_code_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-code_management"></i>zhil-code_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-file_management"></i>zhil-file_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa  zhil-file_view"></i>zhil-file_view</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-files_upload"></i>zhil-files_upload</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-finished_product_transfers"></i>zhil-finished_product_transfers</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-inventory_plan_summary"></i>zhil-inventory_plan_summary</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-inventory_planing_query"></i>zhil-inventory_planing_query</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-inventory_submitted"></i>zhil-inventory_submitted</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-invoice_management"></i>zhil-invoice_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-log_query"></i>zhil-log_query</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-permission_warehouse"></i>zhil-permission_warehouse</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-personal_information"></i>zhil-personal_information</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-release_management"></i>zhil-release_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-request_log_management"></i>zhil-request_log_management</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-save_plan"></i>zhil-save_plan</a></div>
<div class="fa-hover col-md-3 col-sm-4"><a href="#amazon"><i class="fa zhil-single_rule_setting"></i>zhil-single_rule_setting</a></div>
          
	   </div>
	   
          <h2 >${fns:i18nMessage('icon.newIcon')}</h2>
          <div class="row fontawesome-icon-list">
      ...
      <section id="web-application">
          <h2 class="page-header">${fns:i18nMessage('icon.webApplicationIcon')}</h2>
      ...
      <section id="hand">
          <h2 class="page-header">${fns:i18nMessage('icon.handTypeIcons')}</h2>
      ...
      <section id="transportation">
          <h2 class="page-header">${fns:i18nMessage('inon.trafficIcons')}</h2>
      ...
      <section id="gender">
          <h2 class="page-header">${fns:i18nMessage('icon.sexIcon')}</h2>
      ...
      <section id="file-type">
          <h2 class="page-header">${fns:i18nMessage('icon.fileIcon')}</h2>
      ...
      <section id="spinner">
          <h2 class="page-header">${fns:i18nMessage('icon.flashIcon')}</h2>

          <div class="alert alert-success">
              <ul class="fa-ul">
                  <li>
                      <i class="fa fa-info-circle fa-lg fa-li"></i> ${fns:i18nMessage('icon.flashTip1')}
                      <code>fa-spin</code> ${fns:i18nMessage('icon.flashTip2')}
                  </li>
              </ul>
          </div>
      ...
      <section id="form-control">
          <h2 class="page-header">${fns:i18nMessage('icon.formIcon')}</h2>
      ...
      <section id="payment">
          <h2 class="page-header">${fns:i18nMessage('icon.payIcon')}</h2>
      ...
      <section id="chart">
          <h2 class="page-header">${fns:i18nMessage('icon.totalIcon')}</h2>
      ...
      <section id="currency">
          <h2 class="page-header">${fns:i18nMessage('icon.moneyIcon')}</h2>
      ...
      <section id="text-editor">
          <h2 class="page-header">${fns:i18nMessage('icon.textEditorIcons')}</h2>
      ...
      <section id="directional">
          <h2 class="page-header">${fns:i18nMessage('icon.directionIcon')}</h2>
      ...
      <section id="video-player">
          <h2 class="page-header">${fns:i18nMessage('icon.videoPlaybackIcon')}</h2>
      ...
      <section id="brand">
          <h2 class="page-header">${fns:i18nMessage('icon.brandIcon')}</h2>
      ...
      <section id="medical">
          <h2 class="page-header">${fns:i18nMessage('icon.medicalIcon')}</h2>
   ...
   <div class="modal-footer">
       <button type="button" class="btn btn-white" data-dismiss="modal" operation="cancel">${fns:i18nMessage('common.close')}</button>
       <button type="button" class="btn btn-primary" data-dismiss="modal" operation="success">${fns:i18nMessage('common.saves')}</button>
   </div>
</div>
</body>