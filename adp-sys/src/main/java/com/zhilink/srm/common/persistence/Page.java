...
public class Page<T> {
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首页
			sb.append("<li class=\"disabled paginate_button \"><a href=\"javascript:\">&#171; "
					+ I18n.i18nMessage("common.previousPage") + "</a></li>\n");
		} else {
			sb.append("<li class=\"paginate_button\"><a href=\"javascript:\" onclick=\"" + funcName + "(" + prev + ","
					+ pageSize + ",'" + funcParam + "');\">&#171; " + I18n.i18nMessage("common.previousPage")
					+ "</a></li>\n");
		}
		...
		for (int i = begin; i <= end; i++) {
			if (i == pageNo) {
				sb.append("<li class=\"active paginate_button\"><a href=\"javascript:\">" + (i + 1 - first)
						+ "</a></li>\n");
			} else {
				sb.append("<li class=\"paginate_button\"><a href=\"javascript:\" onclick=\"" + funcName + "(" + i + ","
						+ pageSize + ",'" + funcParam + "');\">" + (i + 1 - first) + "</a></li>\n");
		...
		if (pageNo == last) {
			sb.append("<li class=\"disabled paginate_button\"><a href=\"javascript:\">"
					+ I18n.i18nMessage("common.nextPage") + " &#187;</a></li>\n");
		} else {
			sb.append("<li class=\"paginate_button\"><a href=\"javascript:\" onclick=\"" + funcName + "(" + next + ","
					+ pageSize + ",'" + funcParam + "');\">" + I18n.i18nMessage("common.nextPage")
					+ " &#187;</a></li>\n");
		}

		sb.append("<li class=\"disabled controls\"><a id=\"page-text\" href=\"javascript:\">"
				+ I18n.i18nMessage("common.current") + " ");
		...
		sb.append(funcName + "(" + pageNo + ",this.value,'" + funcParam + "');\" onclick=\"this.select();\"/> "
				+ I18n.i18nMessage("common.tiao") + " ");
		sb.append(I18n.i18nMessage("common.total") + " " + +count + " " + I18n.i18nMessage("common.tiao")
	...
	/**
	 * 获取 Hibernate FirstResult 超出索引不返回查询list结果
	 * 
	 * @author an48huf
	 * @date 2018-1-22
	 */
	public int getFirstResult() {
		...
		if (firstResult >= getCount()) {
			firstResult = new Long(getCount()).intValue();
		}
		return firstResult;
	}
