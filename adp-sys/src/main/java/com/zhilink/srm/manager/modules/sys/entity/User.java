...
import com.zhilink.manager.framework.common.supcan.annotation.treelist.cols.SupCol;
...
import com.zhilink.srm.common.utils.excel.fieldtype.RoleListType;
...
public class User extends DataEntity<User> {
	...
	private String ent; // 默认企业编码
	private String site;// 默认企业据点
	private String employeeNo;// 员工编码
	private String employeeName;// erp 员工姓名
	private String language;// 默认语言
	private String departmentNo;// drp 部门编码
	private String departmentName;// erp 部门名称
	private String ware;// 默认仓库

	private String access; // 模组
	...
	@ExcelField(title = "密码", align = 2, sort = 35,type=2)
