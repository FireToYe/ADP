  ...
  extends SimpleBeanInfo
{
  ...
  private static final int PROPERTY_amount = 10;
  private static final int PROPERTY_wmsAppAmount = 11;
  ...
  private static PropertyDescriptor[] getPdescriptor()
  {
    ...
    try
    {
      ...
      arrayOfPropertyDescriptor[10] = new PropertyDescriptor("amount", LicenseContent.class, "getAmount", "setAmount");
      arrayOfPropertyDescriptor[11] = new PropertyDescriptor("wmsAppAmount", LicenseContent.class, "getWmsAppAmount", "setWmsAppAmount");
